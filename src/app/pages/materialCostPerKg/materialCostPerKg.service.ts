...
@Injectable()
export class MaterialCostPerKgService extends MasterService{
  
  constructor(private anHttp: HttpClient, @Inject(APP_CONFIG) private aConfig: IAppConfig, private anAuthService: AuthService) {
    super(anHttp,aConfig,anAuthService);
    this.setApiUrl('materialCostPerKgs/');
  }
}
// import { Injectable, Inject } from '@angular/core';
...
// @Injectable()
// export class MaterialCostPerKgService {
...
//     this.apiUrl = config.apiEndpoint + 'materialCostPerKgs/';
