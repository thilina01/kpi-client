...
export class ResourceUtilizationService extends MasterService {
  ...
  getByMachineAndEmployeeAndProductionDurationAndShiftPage(machine, employee, startDate, endDate, shift, page, size): Observable<any> {
    return this.http.get(this.apiUrl + 'machineAndEmployeeAndProductionDurationAndShiftPage?machine=' + machine + '&employee=' + employee + '&startDate=' + startDate + '&endDate=' + endDate + '&shift=' + shift + '&page=' + page + '&size=' + size)
      .catch(err => this.handleError(err));
  }

  getByMachineAndProductionDurationAndShiftPage(machine, startDate, endDate, shift, page, size): Observable<any> {
    return this.http.get(this.apiUrl + 'machineAndProductionDurationAndShiftPage?machine=' + machine + '&startDate=' + startDate + '&endDate=' + endDate + '&shift=' + shift + '&page=' + page + '&size=' + size)
      .catch(err => this.handleError(err));
  }

  getByMachineAndProductionDurationAndEmployeePage(machine, startDate, endDate, employee, page, size): Observable<any> {
    return this.http.get(this.apiUrl + 'machineAndProductionDurationAndEmployeePage?machine=' + machine + '&startDate=' + startDate + '&endDate=' + endDate + '&employee=' + employee + '&page=' + page + '&size=' + size)
      .catch(err => this.handleError(err));
  }
  
  getByEmployeeAndProductionDurationAndShiftPage(employee, startDate, endDate, shift, page, size): Observable<any> {
    return this.http.get(this.apiUrl + 'employeeAndProductionDurationAndShiftPage?employee=' + employee + '&startDate=' + startDate + '&endDate=' + endDate + '&shift=' + shift + '&page=' + page + '&size=' + size)
      .catch(err => this.handleError(err));
  }
}
