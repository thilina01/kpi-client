...
export class DispatchNoteForm {
    ...
    getaAddressList(): void {
        this.addressService.getCombo().subscribe(addressList => this.addressList = addressList);
    }
    ...
    getDispatchScheduleList(): void {
        this.dispatchScheduleService.getCombo().subscribe(dispatchScheduleList => this.dispatchScheduleList = dispatchScheduleList);
    }

    refresh(): void {

        this.getCustomerList();
        this.getaAddressList();
        this.getEmployeeList();
        this.getDispatchScheduleList();
    }
    ...
    calculateTotal() {       
        ...
        for (let i = 0; i < this.formGroup.value.dispatchList.length; i++) {
            ...
            dispatch.amount = dispatch.quantity;
            amount += parseInt(dispatch.amount);
