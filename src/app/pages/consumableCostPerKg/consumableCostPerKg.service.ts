...
@Injectable()
export class ConsumableCostPerKgService extends MasterService{
  
  constructor(private anHttp: HttpClient, @Inject(APP_CONFIG) private aConfig: IAppConfig, private anAuthService: AuthService) {
    super(anHttp,aConfig,anAuthService);
    this.setApiUrl('consumableCostPerKgs/');
  }
}
// import { Injectable, Inject } from '@angular/core';
...
// @Injectable()
// export class ConsumableCostPerKgService {
...
//     this.apiUrl = config.apiEndpoint + 'consumableCostPerKgs/';
