...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'drawingVersion', canActivate: [AuthGuard], loadChildren: 'app/pages/drawingVersion/drawingVersion.module#DrawingVersionModule' },
      ...
      { path: 'exchangeRate', canActivate: [AuthGuard], loadChildren: 'app/pages/exchangeRate/exchangeRate.module#ExchangeRateModule' },
      ...
      { path: 'subcontractArrivalReject', canActivate: [AuthGuard], loadChildren: 'app/pages/subcontractArrivalReject/subcontractArrivalReject.module#SubcontractArrivalRejectModule' },
      { path: 'subcontractor', canActivate: [AuthGuard], loadChildren: 'app/pages/subcontractor/subcontractor.module#SubcontractorModule' },
      { path: 'subcontractorOperation', canActivate: [AuthGuard], loadChildren: 'app/pages/subcontractorOperation/subcontractorOperation.module#SubcontractorOperationModule' },
      { path: 'subcontractOperationDefinition', canActivate: [AuthGuard], loadChildren: 'app/pages/subcontractOperationDefinition/subcontractOperationDefinition.module#SubcontractOperationDefinitionModule' },
      { path: 'subcontractOperationRate', canActivate: [AuthGuard], loadChildren: 'app/pages/subcontractOperationRate/subcontractOperationRate.module#SubcontractOperationRateModule' },
      { path: 'subcontractRelease', canActivate: [AuthGuard], loadChildren: 'app/pages/subcontractRelease/subcontractRelease.module#SubcontractReleaseModule' },
      { path: 'subcontractNote', canActivate: [AuthGuard], loadChildren: 'app/pages/subcontractNote/subcontractNote.module#SubcontractNoteModule' },
      // { path: 'invoiceType', canActivate: [AuthGuard], loadChildren: 'app/pages/invoiceType/invoiceType.module#InvoiceTypeModule' },
      ...
      { path: 'loadingPlan', canActivate: [AuthGuard], loadChildren: 'app/pages/loadingPlan/loadingPlan.module#LoadingPlanModule' },
      ...
      { path: 'palletSize', canActivate: [AuthGuard], loadChildren: 'app/pages/palletSize/palletSize.module#PalletSizeModule' },
      ...
      { path: ':moduleName', canActivate: [AuthGuard], loadChildren: 'app/pages/codeName/codeName.module#CodeNameModule' }
    ]
  }
];
