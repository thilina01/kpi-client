...
@Injectable()
export class ProductionOverheadCostPerKgService extends MasterService{
  
  constructor(private anHttp: HttpClient, @Inject(APP_CONFIG) private aConfig: IAppConfig, private anAuthService: AuthService) {
    super(anHttp,aConfig,anAuthService);
    this.setApiUrl('productionOverheadCostPerKgs/');
  }
}
// import { Injectable, Inject } from '@angular/core';
...
// @Injectable()
// export class ProductionOverheadCostPerKgService {
...
//     this.apiUrl = config.apiEndpoint + 'productionOverheadCostPerKgs/';
