...
@Injectable()
export class ElectricityCostPerKgService extends MasterService{
  
  constructor(private anHttp: HttpClient, @Inject(APP_CONFIG) private aConfig: IAppConfig, private anAuthService: AuthService) {
    super(anHttp,aConfig,anAuthService);
    this.setApiUrl('electricityCostPerKgs/');
  }
}
// import { Injectable, Inject } from '@angular/core';
...
// @Injectable()
// export class ElectricityCostPerKgService {
...
//     this.apiUrl = config.apiEndpoint + 'electricityCostPerKgs/';
