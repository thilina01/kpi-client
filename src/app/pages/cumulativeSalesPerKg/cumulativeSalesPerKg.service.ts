...
@Injectable()
export class CumulativeSalesPerKgService extends MasterService{
  
  constructor(private anHttp: HttpClient, @Inject(APP_CONFIG) private aConfig: IAppConfig, private anAuthService: AuthService) {
    super(anHttp,aConfig,anAuthService);
    this.setApiUrl('cumulativeSalesPerKgs/');
  }
}
// import { Injectable, Inject } from '@angular/core';
...
// @Injectable()
// export class CumulativeSalesPerKgService {
...
//     this.apiUrl = config.apiEndpoint + 'cumulativeSalesPerKgs/';
