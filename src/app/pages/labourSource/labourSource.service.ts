...
@Injectable()
export class LabourSourceService extends MasterService{
  
  constructor(private anHttp: HttpClient, @Inject(APP_CONFIG) private aConfig: IAppConfig, private anAuthService: AuthService) {
    super(anHttp,aConfig,anAuthService);
    this.setApiUrl('labourSources/');
  }
}
...
// @Injectable()
// export class LabourSourceService {
...
//     this.apiUrl = config.apiEndpoint + 'labourSources/';
