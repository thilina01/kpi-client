...
export class Pages {
  ...
  menuList = [
    ...
    { routerLink: '/pages/designation/table', name: 'Designation', menuType: this.menuType },
    ...
    { routerLink: '/pages/employeeCategory/table', name: 'Employee Category', menuType: this.menuType },
    ...
    { routerLink: '/pages/packingList/table', name: 'Packing List', menuType: this.menuType },
    ...
    { routerLink: '/pages/port/table', name: 'Port', menuType: this.menuType },
